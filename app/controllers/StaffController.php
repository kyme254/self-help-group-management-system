...
class StaffController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				staff.id LIKE ? OR 
				staff.name LIKE ? OR 
				staff.postion LIKE ? OR 
				staff.datejoin LIKE ? OR 
				staff.status LIKE ? OR 
				staff.introduction LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","postion","datejoin","status","introduction");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","postion","datejoin","status","introduction");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
